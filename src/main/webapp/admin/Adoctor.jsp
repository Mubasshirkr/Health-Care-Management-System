...
<div class="fs-3 text-center text-success" role="alert"> ${succMsg}</div> <c: remove var="succMsg" scope="session" />
</c:if> --%>

<form action="../addAdoctor" method="post">
<div class="mb-3">
...
<div class="col-md-8">
<div class="card paint-card"> <div class="card-body">
<p class="fs-3 text-center">Doctor Details</p> <table class="table">
<thead> <tr>
...
<%
	...
	List<Adoctor> list2= dao2.getAllDoctor();
	for(Adoctor d: list2)
	{%>
	<tr>
	<td><%=d.getFullName() %></td>
